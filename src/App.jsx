...
import { postSaveState, getLatestState, getStateById } from "./lib/api";
      ...
      <div className="container">
        <header className="header">
          <div className="titleBlock">
            <h1 className="title">Tone.js סקוונסר גרידי</h1>
            <p className="subtitle">
              כלים מרובים, טעינת דגימות ושמירת מצב (שרת). {useSamples ? "דגימות פעילות" : "מצב סינתים"}
            </p>
          </div>
